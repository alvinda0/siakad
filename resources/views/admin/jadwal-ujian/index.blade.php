...
<style>
    ...
    .exam-actions {
        ...
        gap: .4rem; padding: .875rem 1rem; flex-shrink: 0;
    }
...
<div class="bg-white rounded-2xl border border-slate-100 shadow-sm p-5">
    <form method="GET" id="form-filter" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <div>
    ...
    <div class="tanggal-block" data-tanggal="{{ $tgl }}">
        ...
        <div class="exam-row {{ $isLewat ? 'lewat' : '' }}" data-jenis="{{ $u->jenis }}">
            ...
            <div class="exam-actions">
                ...
                <button type="button"
                        onclick="openUploadKunciModal({{ $u->id }}, '{{ addslashes($u->mataPelajaran->nama) }} – {{ $u->jenis }}')"
                        class="btn-action text-amber-700 bg-amber-50 hover:bg-amber-100">
                ...
                @if($u->file_soal)
                <a href="{{ Storage::url($u->file_soal) }}" target="_blank"
                   class="btn-action text-sky-700 bg-sky-50 hover:bg-sky-100">
                ...
                <button type="button"
                        ...
                        class="btn-action text-red-600 bg-red-50 hover:bg-red-100">
